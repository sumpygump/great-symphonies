...
melody_ia = <<
    ...
    \addlyrics {
        It -- al -- ian, It -- al -- ian is Mend -- els -- sohns's
        name For a sym -- pho -- ny whose mel -- od -- y with light is a -- flame.
    }
>> % }}}
...
melody_ib = <<
    ...
    \addlyrics {
        Just for con -- trast -- ing, This won't be last -- ing.
    }
>> % }}}
...
melody_iiib = <<
    ...
    \addlyrics {
        Horns and bass -- oons in harm -- on -- y
    }
>> % }}}
